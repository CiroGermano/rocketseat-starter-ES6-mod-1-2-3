module.exports = {
    ...
    devServer: { // o dev server imbute o bundle.js na nossa aplicação, então não consiguiremos vê-lo fisicamente. Para isso devemos alterar nosso script de execução. EX: "webpack --mode=production" o script do modo de desenvolvimento que já imbute é: "webpack-dev-server --mode=development"
